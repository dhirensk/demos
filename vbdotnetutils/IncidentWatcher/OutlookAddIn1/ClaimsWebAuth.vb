...
#Disable Warning BC42307 ' XML comment parameter does not match a parameter on the corresponding declaration statement
    ''' <summary>
...
#Enable Warning BC42307 ' XML comment parameter does not match a parameter on the corresponding declaration statement
        ...
        'This Crashes Outlook if you open form using Application to open form since ClaimsWebAuth is Disposable
        'Instead directly open the form without application reference.
